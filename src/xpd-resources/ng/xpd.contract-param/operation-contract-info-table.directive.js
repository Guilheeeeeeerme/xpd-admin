		...
		function link(scope, element, attrs) {
			...
			scope.calculateVCruising = function() {
				...
				try {
					...
					var targetSpeed = scope.contractParams[scope.stateId + 'TripSpeed'].voptimum / 3600;
					var time = Math.abs((displacement / targetSpeed) - scope.operation.inSlips);

					var accelerationTimeLimit = scope.contractParams[scope.stateId + 'TripSpeed'].accelerationTimeLimit;
					var decelerationTimeLimit = scope.contractParams[scope.stateId + 'TripSpeed'].decelerationTimeLimit;
					...
					var vcruising = vCruisingCalculator.calculate(targetSpeed, time, accelerationTimeLimit, decelerationTimeLimit) * 3600;
