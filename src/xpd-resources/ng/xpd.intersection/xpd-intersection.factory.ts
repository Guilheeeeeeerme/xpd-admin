...
export class IntersectionFactory {

	public intersectSegments: any;
	public intersect: any;
	public isParallel: any;
	public isCollinear: any;
	public describe: (a: any, b: any) => { collinear: any; parallel: any; intersection: any; };

	constructor() {
		const intersectionFactory: IntersectionFactory = this;
		...
		const intersection = function() {
			...
			self.intersectSegments = function(a, b) {
				...
				const intersec = vector.add(p, vector.scalarMult(t, r));
				return intersec;
			};
		...
		intersectionFactory.intersectSegments = intersection().intersectSegments;
		intersectionFactory.intersect = intersection().safeIntersect;
		intersectionFactory.isParallel = intersection().isParallel;
		intersectionFactory.isCollinear = intersection().isCollinear;
		intersectionFactory.describe = function(a, b) {
